...
export default class LayoutsComponents extends Vue {
  get username() {
  ...
  get visitedViews() {
    let arr = [];
    arr = TagsViewModule.visitedViews.filter((item: any) => {
  ...
  private version = setting.version;
  private policy = setting.policy;
  private slogoTitle = setting.title;
  private adminName = setting.adminName;
  private showSideBarLogo = setting.showSideBarLogo;
  private showFooter = setting.showFooter;
