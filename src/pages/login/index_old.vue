<template>
  <div class="login-container relative window-height w-full">
    <img
      ...
      alt
      class="absolute left-0 top-0 window-height w-full"
    />
    <q-card class="login-card" :class="useVerifyCode ? 'h-540' : 'h-470'">
      ...
      <q-card-section
        class="row j-between a-center p-t-0"
        v-show="useVerifyCode"
      >
        <q-input
          v-model="verifyCode"
          type="text"
      ...
      <q-card-section class="text-right">
        <div :class="useSwipeVerifyCode ? 'text-primary' : 'text-grey'">
          <span>Use swipe verification code to verify?</span>
          <q-toggle v-model="useSwipeVerifyCode" />
        </div>
