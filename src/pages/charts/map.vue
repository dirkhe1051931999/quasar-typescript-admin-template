<template>
  <div class="map_components">
    ...
    <div id="map" style="width: 100%; height: 100%; height: 636px; transform: scale(0.95)"></div>
  </div>
</template>

<script lang="ts">
import { provinces, provinces2 } from '@/utils/province';
import { loadBdScript } from '@/utils';
