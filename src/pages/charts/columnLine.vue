<template>
  <div>
    <div id="container1" class="full-width h-500 bg-white"></div>
  </div>
</template>
...
@Component({
  name: 'myComponentColumnLine',
})
export default class myComponentColumnLine extends Vue {
  async mounted() {
    const uvData = [
    ...
    const columnLine = new ColumnLine(
      document.getElementById('container1') as any,
      {
        title: {
          visible: true,
