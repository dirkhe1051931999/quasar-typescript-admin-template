<template>
  <div class="q-pa-md">
    <q-layout view="lHh Lpr lFf" container class="shadow-2 rounded-borders h-500">
      ...
      <q-drawer v-model="drawerLeft" :width="150" :breakpoint="700" behavior="desktop" bordered content-class="bg-grey-3">
      ...
      <q-drawer side="right" v-model="drawerRight" bordered :width="150" :breakpoint="500" behavior="desktop" content-class="bg-grey-3">
        <q-scroll-area class="fit">
          <div class="q-pa-sm">
            <div v-for="n in 50" :key="n">Drawer {{ n }} / 50</div>
          </div>
