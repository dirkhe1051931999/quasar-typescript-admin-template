<template>
  <div>
    <q-banner
      ...
      v-show="banner"
    >
      Encapsulate q-form, without writing a bunch of q-input, traverse the array
      to render q-form
...
@Component({
  name: 'myComponentStandard',
})
export default class myComponentStandard extends Vue {
  /**instance */
  declare $refs: any;
  mounted() {}
  /**params */
