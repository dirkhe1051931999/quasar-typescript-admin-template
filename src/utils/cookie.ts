...
export const setLanguage = (language: string) => Cookies.set(languageKey, String(language), config);
const sizeKey = 'size';
...
const pagePermissionIDKey = `${setting.title.replace(/\s/g, '_')}_pagePermissionID`;
